...
/**
 * QuickStartCard — Primary action: start next level via intro page or resume active session.
 */
    ...
    >
        {allLevelsPassed ? (
            ...
            <>
                ...
                <p className="font-body" style={{ fontSize: "0.85rem", color: "var(--grey-400)", lineHeight: 1.6 }}>
                    You have an active Level {activeSessionLevel} session. Resume or start a different level below.
                </p>
